...
Environment Context: If the image is Outdoors (Park, Street, Nature, Air visible), set "isOutdoor": true. If Indoors (Room, House, Lab, Indoor gym), set "isOutdoor": false.
