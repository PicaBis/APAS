...
const STEPS_AR: TourStep[] = [
  ...
  },
  {
    ...
    content: 'شاهد حركة المقذوف مباشرة مع أدوات التكبير/التصغير، الوضع 3D، التصوير، البيانات الحية، الشبكة، وضع التركيز، وتسجيل المحاكاة كفيديو',
    icon: '🚀',
    position: 'top',
  },
  {
    ...
    content: 'تغيير اللغة (AR/EN/FR)، كتم الصوت، الوضع الليلي، دليل التطبيق، التوثيق، مساعد APAS الذكي، وتوصيات APAS',
    icon: '🧭',
    position: 'bottom',
  },
  {
    target: 'right-panel',
    title: 'اللوحة اليمنى',
    content: 'طريقة التكامل (Euler, RK4, AI APAS)، الرؤية الذكية (تحليل الصور والفيديو والنصوص والصوت)، السيناريوهات الجاهزة، إدارة الجلسات، ومشاركة المحاكاة',
    icon: '🔬',
    position: 'left',
  },
  {
    target: 'left-panel',
    title: 'اللوحة اليسرى',
    content: 'المعاملات الفيزيائية (السرعة، الزاوية، الارتفاع، الكتلة، الجاذبية، مقاومة الهواء)، خيارات العرض (البيئة، النقاط الحرجة، القوى، التصوير المتعاقب، الارتداد)، المقارنة، والتصدير (PNG/PDF/QR)',
    icon: '⚙️',
    position: 'right',
  },
  {
    ...
    content: 'تنبؤات APAS AI، المعادلات الفيزيائية، الرسوم البيانية التفاعلية، تحليل الطاقة، ونماذج التنبؤ المتقدمة',
    icon: '📊',
    position: 'top',
  },
];
...
const STEPS_EN: TourStep[] = [
  ...
  },
  {
    ...
    content: 'Watch projectile motion live with zoom in/out, 3D mode, screenshot, live data overlay, grid, focus mode, and simulation recording as video',
    icon: '🚀',
    position: 'top',
  },
  {
    ...
    content: 'Switch language (AR/EN/FR), toggle sound, dark mode, app guide, documentation, APAS AI assistant, and APAS recommendations',
    icon: '🧭',
    position: 'bottom',
  },
  {
    target: 'right-panel',
    title: 'Right Panel',
    content: 'Integration method (Euler, RK4, AI APAS), Smart Vision (image, video, text & voice analysis), preset scenarios, session manager, and simulation sharing',
    icon: '🔬',
    position: 'left',
  },
  {
    target: 'left-panel',
    title: 'Left Panel',
    content: 'Physics parameters (velocity, angle, height, mass, gravity, air resistance), display options (environment, critical points, forces, stroboscopic, bouncing), comparison, and export (PNG/PDF/QR)',
    icon: '⚙️',
    position: 'right',
  },
  {
    ...
    content: 'APAS AI predictions, physics equations, interactive charts, energy analysis, and advanced prediction models',
    icon: '📊',
    position: 'top',
  },
];
