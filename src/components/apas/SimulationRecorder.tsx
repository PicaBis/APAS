  ...
  return (
    <div className="relative">
      ...
      {showPreview && recordedURL && !recording && (
        <div className="absolute top-full right-0 mt-2 w-72 bg-card/95 backdrop-blur-xl border border-border/50 rounded-xl shadow-xl shadow-black/20 z-50 animate-slideDown overflow-hidden">
